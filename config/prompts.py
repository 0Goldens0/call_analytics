...
SUMMARY_MAIN_PROMPT = (
   ...
   " 2.	И еще – проверка хороших новостей – если менеджер хоть каким-либо образом упомянул про хорошие новости (включая все возможные синонимичные фразы) – то значит этот блок полностью отработан и получает максимальную оценку 5 баллов. И не важно какую новость он потом озвучил (на данный момент в этом больше всего ошибок) \n"
